...
- (void)tableView:(UITableView *)tableView willDisplayCell:(UITableViewCell *)cell forRowAtIndexPath:(NSIndexPath *)indexPath;
{
    ...
    if (indexPath.row > 0 || self.pinsHeaderToTop) {
        ...
        [(TSQCalendarRowCell *)cell clearButtonBackGround];
        [(TSQCalendarRowCell *)cell setArrayImages:self.arrayWithImages];
     ...
     //   [(TSQCalendarRowCell *)cell setImageForDateWithArray:self.arrayWithImages beginDate:[self.calendar dateByAddingComponents:dateComponents toDate:firstOfMonth options:0]];
