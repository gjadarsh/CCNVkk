...
- (id)initWithPhotoBrowser:(MWPhotoBrowser *)browser {
    if ((self = [super init])) {
		...
		// Image view
		_photoImageView = [[MWTapDetectingImageView alloc] initWithFrame:CGRectMake(0.0f, 0.0f, 300.0f, 300.0f)];
		_photoImageView.tapDelegate = self;
		_photoImageView.contentMode = UIViewContentModeTop;
        _photoImageView.autoresizingMask = UIViewAutoresizingFlexibleTopMargin;
